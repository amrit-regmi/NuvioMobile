...
internal actual object PlayerSettingsStorage {
    ...
    private fun loadBoolean(key: String): Boolean? =
        WebKeyValueStorage.getBoolean(namespace, scopedKey(key))

    private fun saveBoolean(key: String, value: Boolean) =
        WebKeyValueStorage.setBoolean(namespace, scopedKey(key), value)

    private fun loadFloat(key: String): Float? =
        WebKeyValueStorage.getFloat(namespace, scopedKey(key))

    private fun saveFloat(key: String, value: Float) =
        WebKeyValueStorage.setFloat(namespace, scopedKey(key), value)

    private fun loadInt(key: String): Int? =
        WebKeyValueStorage.getInt(namespace, scopedKey(key))

    private fun saveInt(key: String, value: Int) =
        WebKeyValueStorage.setInt(namespace, scopedKey(key), value)

    private fun loadString(key: String): String? =
        WebKeyValueStorage.getString(namespace, scopedKey(key))

    private fun saveString(key: String, value: String) =
        WebKeyValueStorage.setString(namespace, scopedKey(key), value)
    ...
    private fun loadStringSet(key: String): Set<String>? {
        ...
        if (!WebKeyValueStorage.contains(namespace, scopedKey)) return null
        return WebKeyValueStorage.getString(namespace, scopedKey)
            .orEmpty()
            .lineSequence()
            .map { it.trim() }
    ...
    private fun saveStringSet(key: String, value: Set<String>) =
        WebKeyValueStorage.setString(namespace, scopedKey(key), value.joinToString(separator = "\n"))
}
